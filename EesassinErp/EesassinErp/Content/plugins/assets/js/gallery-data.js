...
var masonryPortfolio = function() {	
		...
		if( $('.portfolio-wrap').length > 0 ){	
		    ...
		    $(window).on('resize', function () {
		        ...
		        $('.wrapper').find('.page-wrapper-m-h').css({ "min-height": Wheight });
			    debugger;
...
/***** LightGallery init start*****/
 ...
 //showThumbByDefault: false, hash: false
 //     });
 // });

//$('#main-gallery').find('.portf').lightGallery({ showThumbByDefault: false, hash: false });
