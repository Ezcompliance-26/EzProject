...
if (typeof Object.create !== "function") {
    ...
    var i = {
        ...
        buildNavigation: function () {
            ...
            var ulId = e(t).find(".select-box-list3").find("ul");
            var id = $(ulId[0]).attr("id");
            //alert(classname)
            if (t) {
                ...
                var n = '<a id="p' + id + '" href="#" class="prev"><span class="glyphicon glyphicon-chevron-down"></span></a>' + '<a id="n' + id + '" href="#" class="next"><span class="glyphicon glyphicon-chevron-up"></span></a>';
                var r = e(t).find(".panel-footer")[0];
                if (r) {
                    e(r).append(n)
                } else {
                    //e(t).append('<div class="panel-footer">' + n + "</div>")
                    var selectboxlist3 = e(t).find(".select-box-list3");
                    //alert($(sss[0]).html());
                    $(selectboxlist3).append('<div class="panel-scroll">' + n + "</div>");
                    //alert($(".select-box-list3").height());
                    //$(".select-box-list3").find("ul")[0].css({ "height": $(".select-box-list3").height() });
                }
                var i = this;

                e(t).find('#p' + id + '.prev').on("click", function (e) {
                    e.preventDefault();
                    i.onPrev()
                });
                e(t).find('#n' + id + '.next').on("click", function (e) {
                    e.preventDefault();
                    i.onNext()
                })
            }
