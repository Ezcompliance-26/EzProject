app.ClientActMapping = function ($scope, $element, $filter, $sce, myService) {
    ...
    $scope.SaveRecord = function () {
        ...
        if (isValidate()) {
            ...
            var getData = myService.methode('POST', "../ClientActMapping/IUDClientActMapping", '{obj:' + JSON.stringify(collectionobj) + '}');
            getData.then(function (response) {
