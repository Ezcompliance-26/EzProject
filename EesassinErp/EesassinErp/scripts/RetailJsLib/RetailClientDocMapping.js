app.RetailClientDocMapping = function ($scope, $element, $filter, $sce, myService) {
    ...
    $scope.SaveRecord = function () {
        ...
        if (isValidate()) {
            ...
            var getData = myService.methode('POST', "../Retail/IUDRetailClientDocMapping", '{obj:' + JSON.stringify(collectionobj) + '}');
            getData.then(function (response) {
