app.SecretarialStatutorySetupController = function ($scope, $element, $filter, myService) {
    ...
    $scope.Binddasboard = function () {
        ...
        debugger;
        var getData = myService.methode('POST', "../Retail/SearchSecretarialStatutorySetup", collectionobj);
    ...
    $scope.SaveAfterValidate = function () {
        if (isValidate()) {
            ...
            var getData = myService.methode('POST', "../Retail/IUDSecretarialStatutorySetup", '{obj:' + JSON.stringify(collectionobj) + '}');
            getData.then(function (response) {
