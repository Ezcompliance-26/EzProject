app.GradeMasterController = function ($scope, $element, $filter, myService) {
    ...
    $scope.SaveRecord = function () {
        ...
        if (isValidate()) {
            ...
            collectionobj.PartyName = $scope.GradeName;
            collectionobj.Description = $scope.Description;
            collectionobj.Attribute1 = $scope.Sequence;
            ...
            var getData = myService.methode('POST', ("../Retail/InsertUpdateDelGradeMaster"), JSON.stringify(collectionobj));
            getData.then(function (response) {
    ...
    $scope.started = function () {
        ...
        debugger;
        var getData = myService.methode('POST', ("../Retail/SearchGradeMaster"), JSON.stringify(collectionobj));
        getData.then(function (response) {
            var tblheader =
                [
                    ...
                    { "HeaderText": "Grade Name", "HeaderValue": "Name", "Width": "100%", "ShowColumn": "Yes", "ImageColumn": "No" },
                    { "HeaderText": "Sequence No", "HeaderValue": "Sequence", "Width": "100%", "ShowColumn": "Yes", "ImageColumn": "No" },
            ...
            $('#example tbody').on('dblclick', 'tr', function () {
                ...
                $scope.$applyAsync();
                const FORMAT = "DD-MM-YYYY";
                $scope.GradeName = $scope.MasterList[0].Name;
                $scope.Sequence = $scope.MasterList[0].Sequence;
