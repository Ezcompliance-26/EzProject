app.RetailCreateActCalenderController = function ($scope, $element, $filter, myService) {
    ...
    $scope.ResetControl = function (flag) {
        ...
        $scope.State = '';
        $scope.Act = '';
        $scope.Section = ''; $scope.Rule = ''; $scope.FormNo = '';
        $scope.Constitution = '';
        $scope.Department = '';
        $scope.Month = '';
        $scope.Year = '';
    ...
    $scope.deleteRecord = function () {
        ...
        var getData = myService.methode('POST', ("../Retail/IUDRetailCreateActCalender"), JSON.stringify(collectionobj));
        getData.then(function (response) {
    ...
    $scope.SaveRecord = function () {
      ...
      if (isValidate()) {
          ...
          safeAppend("FormNo", $scope.FormNo);
            ...
            // Send data via AJAX
            $.ajax({
                url: "../Retail/IUDRetailCreateActCalender",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
