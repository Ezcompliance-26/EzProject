app.AddAuditContractorComplianceController = function ($scope, $element, $filter, myService, $http, $compile, $timeout) {
    $scope.SelectedActs = [];
    ...
    $scope.DisplaymiscellaneousSectionOnly = function () {
        ...
        rdr.onload = () => {
            ...
            const miscFields = [
                ...
                "Earned_Medical", "Name_of_Employer", "Years", "Payment_Date", "Insurance_No", "SiteCode"
    ...
    $scope.AfterSaveRecord = function () {
        ...
        function formatMiscList(list) {
            const miscFields = [
                ...
                "Amountof_wages_Paid_section9", "Amountof_wages_Paidleave_section10", "Nominated_person", "Women_dies_Date_and_beneift_person",
                "if_mother_dies_child_survive_beneift", "Deduction_Incentive", "Holiday_List", "Holiday_Day", "Holiday_Date", "Earned_Statutory_Bonus",
                "Earned_Medical", "Name_of_Employer",   "Years", "Payment_Date", "Insurance_No", "SiteCode", "ComplianceCategory"
            ];
        ...
        $http.post("/Api/RetailSectionApi/AuditIUDBulkContractorComplianceExcel", formData, {
