app.RetailLabourCodeComplianceController = function ($scope, $element, $filter, myService) {
    ...
    $scope.Expirethroughshowduedate = function ()
    {
        if ($scope.Expire == 'Not Specified')
            {
            $scope.DueDay ='Not Specified'
            }
    }
    ...
    $scope.ResetControl = function (flag) {
        ...
        $scope.UploadFile = '';
        $scope.Industry = '';
        $scope.DetailedCompliance = '';
        $scope.ImpactEmployer = '';
    ...
    $scope.deleteRecord = function () {
        ...
        var getData = myService.methode('POST', ("../Retail/IUDLabourcodeCompliance"), JSON.stringify(collectionobj));
        getData.then(function (response) {
    ...
    $scope.started = function () {
        ...
        debugger;
        var getData = myService.methode('POST', ("../Retail/SearchLabourcodeCompliance"), JSON.stringify(collectionobj));
        getData.then(function (response) {
            var tblheader =
                [
                    {
                    ...
                    { "HeaderText": "FormNo", "HeaderValue": "FormNo", "Width": "100%", "ShowColumn": "Yes", "ImageColumn": "No" },
                    { "HeaderText": "Detailed Compliance", "HeaderValue": "DetailedCompliance", "Width": "100%", "ShowColumn": "Yes", "ImageColumn": "No" },
                    { "HeaderText": "Impact Employer", "HeaderValue": "ImpactEmployer", "Width": "100%", "ShowColumn": "Yes", "ImageColumn": "No" },
            ...
            $('#example tbody').on('dblclick', 'tr', function ()
            {
                ...
                $scope.FormNo = $scope.SearchMasterList[0].FormNo;
                ...
                $scope.DetailedCompliance = $scope.SearchMasterList[0].DetailedCompliance;
                $scope.ImpactEmployer = $scope.SearchMasterList[0].ImpactEmployer;
    ...
    $scope.SaveRecord = function () {
      ...
      if (isValidate()) {
          ...
          safeAppend("FormNo", $scope.FormNo);
          safeAppend("DetailedCompliance", $scope.DetailedCompliance);
          safeAppend("ImpactEmployer", $scope.ImpactEmployer);
          ...
          safeAppend("currDate", dateStr);
            ...
            // Send data via AJAX
            $.ajax({
                url: "../Retail/IUDLabourcodeCompliance",
                type: "POST",
                data: formData,
                contentType: false, 
