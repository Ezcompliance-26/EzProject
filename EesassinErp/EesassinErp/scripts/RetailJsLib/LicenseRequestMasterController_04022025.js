app.LicenseRequestMasterController = function ($scope, $element, $filter, myService) {
    ...
    $scope.selectedColumns = [
        ...
        'ApplicationStatus', 'ApplicationDate', 'LicenseStatus', 'IssuedDate', 'LicenseNumber', 'ValidityStartDate', 'ValidityEndDate',
        'RenewalRequestDate', 'RenewalStartDate', 'RenewalStatus', 'RenewalEnddate', 'UserName', 'UserPassword', 'MobileNumber', 'EmailId', 'ActualCost', 'GovtFees'
    ];
