app.RetailFactoryComplianceController = function ($scope, $element, $filter, myService) {
    ...
    $scope.deleteRecord = function () {
        ...
        var getData = myService.methode('POST', ("../Retail/IUDFactoryCompliance"), JSON.stringify(collectionobj));
        getData.then(function (response) {
    ...
    $scope.started = function () {
        ...
        debugger;
        var getData = myService.methode('POST', ("../Retail/SearchFactoryCompliance"), JSON.stringify(collectionobj));
        getData.then(function (response) {
            var tblheader =
                [
                    {
    ...
    $scope.SaveRecord = function () {
      ...
      if (isValidate()) {
          ...
          safeAppend("currDate", dateStr);
            ...
            // Send data via AJAX
            $.ajax({
                url: "../Retail/IUDFactoryCompliance",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
