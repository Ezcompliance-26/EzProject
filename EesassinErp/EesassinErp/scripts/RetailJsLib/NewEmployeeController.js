    ...
    $scope.SaveEmployee = function () {
        ...
        if (isValidate())
        {
            ...
            if (_isFileValid) {
                ...
                formData.append("MinimumWageCategory", $scope.Photos_4_FilePath_Preview);
                formData.append("WageType", $scope.Photos_4_FilePath_Preview);
                formData.append("WageDisbursementMode", $scope.Photos_4_FilePath_Preview);
            formData.append("PPE = "";
            formData.append("PPEType = "";
            formData.append("SafetyTrainingStatus = "";
            formData.append("SiteInductionStatus = "";
            formData.append("PoliceVerificationStatus = "";
            formData.append("TempIDStatus = "";
            formData.append("TempIDNumber = "";
            formData.append("TempIDDate = "";
            formData.append("PermanentIDStatus = "";
            formData.append("PermanentIDNumber = "";
            formData.append("PermanentIDDate = "";
                $('#txtTempIDDate').val('');
